                ...
                <div class="post-container">
                  ...
                  ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                              <div class="inner-content clearfix">
                                  <h3><a href='single.php?id=<?php echo $row['driver_id']; ?>'><?php echo $row['state']; ?></a></h3>
                                  <div class="post-information">
                                      <span>
                                          <i class="fa fa-tags" aria-hidden="true"></i>
                                          <a href='category.php?cid=<?php echo $row['name']; ?>'><?php echo $row['name']; ?></a>
                                      </span>
                                      <span>
                                          <i class="fa fa-user" aria-hidden="true"></i>
                                          <a href='author.php?aid=<?php echo $row['username']; ?>'><?php echo $row['username']; ?></a>
                                      </span>
                                      <span>
                    ...
                    $sql1 = "SELECT * FROM driver
                            WHERE driver.state LIKE '%{$search_term}%'";
